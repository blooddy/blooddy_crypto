...
package by.blooddy.crypto.math {
	...
	public class BigIntegerBlock {
		 ...
		 * @return		v1 & ~v2
		 */
		public static function andNot(v1:MemoryBlock, v2:MemoryBlock, pos:int=-1):MemoryBlock {
			
			var l1:int = v1.len;
			var l2:int = v2.len;
			
			if ( l1 == 0 || l2 == 0 ) return v1;
			else {
		 ...
		 * @return		v1 | v2
		 */
		public static function or(v1:MemoryBlock, v2:MemoryBlock, pos:int=-1):MemoryBlock {
