...
package by.blooddy.crypto {
	...
	public final class Base64 {
		...
		_DECODE_TABLE.writeUTFBytes(
			'' +
			''
		);
		...
		public static function decode(str:String):ByteArray {
			...
			try {
				...
				do {
					...
					if ( a >= 0x40 ) {
						while ( a == 0x41 ) { // пропускаем пробелы
							a = Memory.getUI8( Memory.getUI8( ++i ) );
						}
						if ( a == 0x40 ) { // наткнулись на pad
							b = c = d = 0x40;
							break;
					...
					if ( c >= 0x40 ) {
						while ( c == 0x41 ) { // пропускаем пробелы
							c = Memory.getUI8( Memory.getUI8( ++i ) );
						}
						if ( c == 0x40 ) { // наткнулись на pad
							d = 0x40;
							break;
					...
					if ( d >= 0x40 ) {
						while ( d == 0x41 ) { // пропускаем пробелы
							d = Memory.getUI8( Memory.getUI8( ++i ) );
						}
						if ( d == 0x40 ) { // наткнулись на pad
							break;
				...
				while ( i < bytesLength ) {
					if ( !( Memory.getUI8( Memory.getUI8( ++i ) & 0x40 ) ) ) { // что-то помимо
						Error.throwError( VerifyError, 1509 );
					}
				}
